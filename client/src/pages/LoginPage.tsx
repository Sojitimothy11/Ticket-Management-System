  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#0e1116] px-4">
      <div className="w-full max-w-sm rounded-xl border border-white/10 bg-card p-10 shadow-xl">
        ...
        <h1 className="mb-1 font-heading text-2xl font-semibold text-foreground">Sign In</h1>
        <p className="mb-7 text-sm text-muted-foreground">Sign in to your account to continue</p>
        ...
        <p className="mt-5 text-center text-sm text-muted-foreground">
          ...
          <Link to="/signup" className="font-medium text-harbor hover:underline">
            Sign up
          </Link>
        </p>
      </div>
